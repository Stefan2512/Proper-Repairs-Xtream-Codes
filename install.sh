...
#
# ==============================================================================
# Xtream Codes "Proper Repairs" - Installer v5.0 (Stefan2512 Fork)
# ==============================================================================
# Created by: Gemini AI
# Date: 2025-06-20
#
# KEY IMPROVEMENTS:
# - v5.0: Final version using assets EXCLUSIVELY from the Stefan2512 repository,
#         as per user's definitive instruction. All external dOC4eVER links removed.
#         Uses self-contained logic for dependencies and configuration.
...
# The archive should contain the `iptv_xtream_codes` directory, which gets created inside /home/xtreamcodes
tar -xzf "/tmp/panel.tar.gz" -C "/home/xtreamcodes/"

# Verify the directory was created
if [ ! -d "$XC_PANEL_DIR" ] || [ -z "$(ls -A "$XC_PANEL_DIR")" ]; then
    log_error "Extraction failed or the archive is empty/structured differently. The target directory $XC_PANEL_DIR does not exist or is empty."
fi
